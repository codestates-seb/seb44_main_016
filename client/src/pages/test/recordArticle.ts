...
export const recordArticle = [
  ...
  //   price: -10000000,
  //   content: '무료인줄 알았는데 사립인가보네요 교육/학습 짱비싸네요. 비추합니다.',
  //   scope: '가계부 타임라인',
  //   imgPath: [
  ...
  //   scope: '가계부 타임라인',
  //   imgPath: ['https://image.edaily.co.kr/images/photo/files/NP/S/2022/11/PS22112801166.jpg'],
  //   user: {
  //     userId: 2,
  //     profileImgPath:
  //       'https://i.namu.wiki/i/VxdEKDNZCp9hAW5TU5-3MZTePLGSdlYKzEZUyVLDB-Cyo950Ee19yaOL8ayxgJzEfMYfzfLcRYuwkmKEs2cg0w.webp',
  ...
  //   scope: '가계부 게시글',
  //   imgPath: ['https://blog.kakaocdn.net/dn/bcOiIk/btseT1XwQHL/frw5KjTFECKzzk5EdPHcGK/img.jpg'],
  //   user: {
  //     userId: 2,
  //     profileImgPath:
  //       'https://i.namu.wiki/i/VxdEKDNZCp9hAW5TU5-3MZTePLGSdlYKzEZUyVLDB-Cyo950Ee19yaOL8ayxgJzEfMYfzfLcRYuwkmKEs2cg0w.webp',
