...
export const TimelineArticleDummyA: FaRecArticleResType = {
...
export const TimelineArticleDummyB: FaRecArticleResType = {
  financialRecordId: 0, // 지출/수입이 속한 가계부 ID
  financialRecordArticleId: 0,
  category: '',
  faDate: '2023-12-23T12:34:56.789Z',
...
export const feedArticleDummyA: FeedArticleResType = {
  feedArticleId: 1,
  feedType: '절약팁',
  user: {
    userId: 2, // BigInt
...
export const feedArticleDummyB: FeedArticleResType = {
  feedArticleId: 2,
  feedType: '허락해줘',
  user: {
    userId: 3, // BigInt
