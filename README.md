![header](https://capsule-render.vercel.app/api?type=waving&color=auto&height=300&section=header&text=제로힙&fontSize=70&animation=fadeIn&fontAlignY=38&desc=절약유도%20가계부형%20SNS&descAlignY=53&descAlign=65)
...
1. 제로힙에서는 웹, 모바일로 언제 어디서든 필요할 때마다 바로바로 소비에 대한 기록을 할 수 있습니다.
   - 주제에 따라 가계부를 만들 수 있고, 매일 기록을 할 수 있게 간편한 기록 서비스를 제공합니다.
2. 제로힙에서는 소비의 가치를 알기에, 소중한 소비와 함께 한 추억을 타임라인에 차곡 차곡 저장해줍니다.
...
3. 제로힙에서는 과시를 조장하는 SNS가 아닌 **절약을 전시하는 SNS**를 제공합니다. 
...
4. 제로힙에서는 나에게 필요하지 않은 소비를 말려줄 유저들이 모인 곳이기도 한답니다. 
...
|   이름    |  👑 이선아 |  오은비    |   오현석   |
|----------|----------|----------|-------------|
|  이번 <br> 프로젝트를 <br> 한 짤로 <br> 표현한다면? | <img  src="https://media.discordapp.net/attachments/1123432177485500486/1130304142242500628/IMG_7512.jpeg.jpg?width=926&height=1192" alt="이선아" width="180" height="180"/>| <img  src="https://media.discordapp.net/attachments/1123432177485500486/1132179977727656006/FDVGXQ7aMAAQ9qc.png?width=1280&height=1040" alt="오은비" width="180" height="180"/> | <img  src="https://media.discordapp.net/attachments/1123432177485500486/1130337870712950915/3998174577.jpg?width=1590&height=1192" alt="오현석" width="180" height="180"/> 
...
|   이름    |  👑 서재곤 |  김윤희    |   최한별   |
|----------|----------|----------|-------------|
| 이번 <br> 프로젝트를 <br> 한 짤로 <br> 표현한다면? | <img  src="https://media.discordapp.net/attachments/1125994197258879058/1132137505148387397/8a6eb22d821350fe.png?width=1112&height=1182" alt="서재곤" width="180" height="180"/>| <img  src="https://media.discordapp.net/attachments/1123432177485500486/1130326842595868682/2023-06-12_115555.png?width=1179&height=1192" alt="김윤희" width="180" height="180"/> | <img  src="https://media.discordapp.net/attachments/1123432177485500486/1131820014777942067/externalFile.jpg?width=1567&height=1182" alt="최한별" width="180" height="180"/> 
...
| 구현 기능 |  ?? | ?? | - 회원 CRUD, MyPage 구현<br>-Spring Security , OAuth2.0 로그인 인증<br>-JWT 생성 및 발급을 통한 사용자 인증<br>-비즈니스 로직 예외처리 추상화 및 공통화 | 
| 공통 작업 |   ?? |  ?? |  - 인터페이스 설계 및 추상화<br>-ERD 테이블 설계<br>-API 명세서  | 
...
<p align='center'><img  src="https://media.discordapp.net/attachments/1123431285671612496/1132216891654541332/image.png?width=1935&height=1222" alt="제로힙 시술스택" width="600" height="400"/> </p>
